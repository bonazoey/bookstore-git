...
td {
	...
	<main>
		<h2>도서 상세</h2>
		<form action="book?cmd=edit" method="post" enctype="multipart/form-data" id="uploadForm">
				...
				<tr>
					...
					<td class="disp"><c:if test="${vo.savefilename !=null}">
							<img style="height: 300px;"
								src="book?cmd=imgDown&upload=${vo.savepath}&savedFname=${vo.savefilename}&originFname=${vo.srcfilename}"
								alt="no-image" />
						</c:if></td>
			...
			<br>
			<div class="btn_rud">
			<button type="button" id="btnList" class="btn btn-success" onclick="location.href='book?page=${page}&searchword=${searchword}&searchtype=${searchtype}'">도서목록</button>
...
*=============================================*/
	...
	function bookDelete() {
		if (confirm("도서 삭제를 수행하시겠습니까?")) {
			location.href="book?cmd=delete&bno=${vo.bno}";
		}
	}
</script>
